...
int main(int argc, char **argv)
{
    ...
    // Shader
    Shader shader("./src/22-GeometryShader-3-NormalVisualization/Shaders/default.vs", "./src/22-GeometryShader-3-NormalVisualization/Shaders/default.fs");
    Shader normalShader("./src/22-GeometryShader-3-NormalVisualization/Shaders/normal_visualization.vs",
                  "./src/22-GeometryShader-3-NormalVisualization/Shaders/normal_visualization.fs",
                  "./src/22-GeometryShader-3-NormalVisualization/Shaders/normal_visualization.gs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        normalShader.Use();
        normalShader.SetMat4f("projection", projection);
