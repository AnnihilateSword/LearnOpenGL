...
int main(int argc, char** argv)
{
    ...
    // 1. shader
    Shader lightingShader("./src/12-LightCasters/Shaders/VertexShader.glsl", "./src/12-LightCasters/Shaders/FragmentShader.glsl");
    Shader lightCubeShader("./src/12-LightCasters/Shaders/LightCubeVertexShader.glsl", "./src/12-LightCasters/Shaders/LightCubeFragmentShader.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // set light
        lightingShader.SetVec3f("uLight.ambient", 0.1f, 0.1f, 0.1f);
        lightingShader.SetVec3f("uLight.diffuse", 0.8f, 0.8f, 0.8f);
        lightingShader.SetVec3f("uLight.specular", 1.0f, 1.0f, 1.0f);
        lightingShader.SetVec3f("uLight.position", camera.Position);
        lightingShader.SetVec3f("uLight.direction", camera.Front);
        // 这里返回的是余弦值（不想在GPU中运算了）
        lightingShader.SetFloat("uLight.cutOff", glm::cos(glm::radians(12.5f)));
        lightingShader.SetFloat("uLight.outerCutOff", glm::cos(glm::radians(17.5f)));
        lightingShader.SetFloat("uLight.constant", 1.0f);
        lightingShader.SetFloat("uLight.linear", 0.09f);
        lightingShader.SetFloat("uLight.quadratic", 0.032f);
