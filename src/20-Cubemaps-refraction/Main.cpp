...
int main(int argc, char** argv)
{
    ...
    // Shader
    Shader shader("./src/20-Cubemaps-refraction/Shaders/Cubemap.vs", "./src/20-Cubemaps-refraction/Shaders/Cubemap.fs");
    Shader skyboxShader("./src/20-Cubemaps-refraction/Shaders/Skybox.vs", "./src/20-Cubemaps-refraction/Shaders/Skybox.fs");
