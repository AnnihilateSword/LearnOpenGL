...
int main(int argc, char** argv)
{
    ...
    // Shader
    Shader shader("./src/20-Cubemaps-optimise/Shaders/Cubemap.vs", "./src/20-Cubemaps-optimise/Shaders/Cubemap.fs");
    Shader skyboxShader("./src/20-Cubemaps-optimise/Shaders/Skybox.vs", "./src/20-Cubemaps-optimise/Shaders/Skybox.fs");
