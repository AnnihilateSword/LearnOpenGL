...
int main(int argc, char** argv)
{
    ...
    // 1. shader
    Shader lightingShader("./src/09-BasicLighting/Shaders/VertexShader.glsl", "./src/09-BasicLighting/Shaders/FragmentShader.glsl");
    Shader lightCubeShader("./src/09-BasicLighting/Shaders/LightCubeVertexShader.glsl", "./src/09-BasicLighting/Shaders/LightCubeFragmentShader.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.SetVec3f("uLightPos", LightPos);
