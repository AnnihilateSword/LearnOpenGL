...
int main(int argc, char** argv)
{
    ...
    // Shader
    Shader shader("./src/20-Cubemaps-reflection-model/Shaders/Cubemap.vs", "./src/20-Cubemaps-reflection-model/Shaders/Cubemap.fs");
    Shader skyboxShader("./src/20-Cubemaps-reflection-model/Shaders/Skybox.vs", "./src/20-Cubemaps-reflection-model/Shaders/Skybox.fs");
    ...
    {
        "./res/textures/skybox/chruch/lposx.png",
        "./res/textures/skybox/chruch/lnegx.png",
        "./res/textures/skybox/chruch/lposy.png",
        "./res/textures/skybox/chruch/lnegy.png",
        "./res/textures/skybox/chruch/lposz.png",
        "./res/textures/skybox/chruch/lnegz.png"
    };
