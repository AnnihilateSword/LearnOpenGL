...
int main(int argc, char** argv)
{
    ...
    // Shader
    Shader shader("./src/20-Cubemaps/Shaders/Cubemap.vs", "./src/20-Cubemaps/Shaders/Cubemap.fs");
    Shader skyboxShader("./src/20-Cubemaps/Shaders/Skybox.vs", "./src/20-Cubemaps/Shaders/Skybox.fs");
