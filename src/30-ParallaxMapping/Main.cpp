...
int main(int argc, char **argv)
{
    ...
    // Shader
    Shader shader("./src/30-ParallaxMapping/Shaders/parallax_mapping.vs", "./src/30-ParallaxMapping/Shaders/parallax_mapping.fs");

    // load textures
    // -------------
    unsigned int diffuseMap = TextureFromFile("bricks2.jpg", "./res/textures/", false, false);
    unsigned int normalMap = TextureFromFile("bricks2_normal.jpg", "./res/textures/", false, false);
    unsigned int heightMap = TextureFromFile("bricks2_disp.jpg", "./res/textures/", false, false);
