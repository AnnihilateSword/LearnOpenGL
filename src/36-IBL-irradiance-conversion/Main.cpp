...
// Camera
Camera camera(glm::vec3(2.0f, 2.0f, 9.0f), {0, 1, 0}, -99.0f);
float LastX{};
float LastY{};
...
int main(int argc, char **argv)
{
    ...
    // Shader
    // -------------------------
    Shader pbrShader("./src/36-IBL-irradiance-conversion/Shaders/pbr.vs", "./src/36-IBL-irradiance-conversion/Shaders/pbr.fs");
    Shader equirectangularToCubemapShader("./src/36-IBL-irradiance-conversion/Shaders/cubemap.vs", "./src/36-IBL-irradiance-conversion/Shaders/equirectangular_to_cubemap.fs");
    Shader backgroundShader("./src/36-IBL-irradiance-conversion/Shaders/background.vs", "./src/36-IBL-irradiance-conversion/Shaders/background.fs");
