...
int main(int argc, char **argv)
{
    ...
    // Shader
    // -------------------------
    Shader shader("./src/35-PBR-lighting-texture/Shaders/pbr.vs", "./src/35-PBR-lighting-texture/Shaders/pbr.fs");
    ...
    // --------------------------
    unsigned int albedo    = TextureFromFile("albedo.png", "./res/textures/pbr/rustediron1-alt2-Unreal-Engine/");
    unsigned int normal    = TextureFromFile("normal.png", "./res/textures/pbr/rustediron1-alt2-Unreal-Engine/");
    unsigned int metallic  = TextureFromFile("metallic.png", "./res/textures/pbr/rustediron1-alt2-Unreal-Engine/");
    unsigned int roughness = TextureFromFile("roughness.png", "./res/textures/pbr/rustediron1-alt2-Unreal-Engine/");
    unsigned int ao        = TextureFromFile("ao.png", "./res/textures/pbr/rustediron1-alt2-Unreal-Engine/");
