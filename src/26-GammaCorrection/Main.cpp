...
int main(int argc, char **argv)
{
    ...
    // Shader
    Shader shader("./src/26-GammaCorrection/Shaders/gamma_correction.vs", "./src/26-GammaCorrection/Shaders/gamma_correction.fs");
    ...
    // load textures
    // -------------
    unsigned int floorTexture = TextureFromFile("wood.png", "./res/textures/", false, false);
    unsigned int floorTextureGammaCorrected = TextureFromFile("wood.png", "./res/textures/", false, true);
