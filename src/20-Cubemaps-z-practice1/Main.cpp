...
int main(int argc, char** argv)
{
    ...
    // Shader
    Shader shader("./src/20-Cubemaps-z-practice1/Shaders/model.vs", "./src/20-Cubemaps-z-practice1/Shaders/model.fs");
    Shader skyboxShader("./src/20-Cubemaps-z-practice1/Shaders/Skybox.vs", "./src/20-Cubemaps-z-practice1/Shaders/Skybox.fs");
    ...
    // --------------------
    shader.Use();
    // 注意这里设置的索引是 4，这里设置大一点的原因是因为模型已经占用了3个索引
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // model
        glBindVertexArray(cubeVAO);
        glActiveTexture(GL_TEXTURE4);  // 激活纹理 4
