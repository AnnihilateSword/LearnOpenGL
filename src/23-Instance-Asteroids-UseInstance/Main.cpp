...
int main(int argc, char **argv)
{
    ...
    // Shader
    Shader asteroidShader("./src/23-Instance-Asteroids-UseInstance/Shaders/asteroid.vs", "./src/23-Instance-Asteroids-UseInstance/Shaders/asteroid.fs");
    Shader planetShader("./src/23-Instance-Asteroids-UseInstance/Shaders/planet.vs", "./src/23-Instance-Asteroids-UseInstance/Shaders/planet.fs");
    // skybox
    Shader skyboxShader("./src/23-Instance-Asteroids-UseInstance/Shaders/Skybox.vs", "./src/23-Instance-Asteroids-UseInstance/Shaders/Skybox.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(GL_TEXTURE_2D, rock.TexturesLoaded[0].ID); // note: we also made the TexturesLoaded vector public (instead of private) from the model class.
        for (unsigned int i = 0; i < rock.Meshes.size(); i++)
        {
