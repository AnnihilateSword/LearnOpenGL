...
int main(int argc, char **argv)
{
    ...
    // Shader
    // -------------------------
    Shader pbrShader("./src/36-IBL-irradiance-Use/Shaders/pbr.vs", "./src/36-IBL-irradiance-Use/Shaders/pbr.fs");
    Shader equirectangularToCubemapShader("./src/36-IBL-irradiance-Use/Shaders/cubemap.vs", "./src/36-IBL-irradiance-Use/Shaders/equirectangular_to_cubemap.fs");
    Shader irradianceShader("./src/36-IBL-irradiance-Use/Shaders/cubemap.vs", "./src/36-IBL-irradiance-Use/Shaders/irradiance_convolution.fs");
    Shader backgroundShader("./src/36-IBL-irradiance-Use/Shaders/background.vs", "./src/36-IBL-irradiance-Use/Shaders/background.fs");
