...
int main(int argc, char **argv)
{
    ...
    // Shader
    Shader simpleDepthShader("./src/27-ShadowMapping-1-DepthMap/Shaders/shadow_mapping_depth.vs", "./src/27-ShadowMapping-1-DepthMap/Shaders/shadow_mapping_depth.fs");
    Shader debugDepthShader("./src/27-ShadowMapping-1-DepthMap/Shaders/debug_quad.vs", "./src/27-ShadowMapping-1-DepthMap/Shaders/debug_quad.fs");
