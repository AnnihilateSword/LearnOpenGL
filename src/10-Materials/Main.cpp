...
int main(int argc, char** argv)
{
    ...
    // 1. shader
    Shader lightingShader("./src/10-Materials/Shaders/VertexShader.glsl", "./src/10-Materials/Shaders/FragmentShader.glsl");
    Shader lightCubeShader("./src/10-Materials/Shaders/LightCubeVertexShader.glsl", "./src/10-Materials/Shaders/LightCubeFragmentShader.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.Use();
        // set object material
        lightingShader.SetVec3f("uMaterial.ambient", 1.0f, 0.5f, 0.31f);
        lightingShader.SetVec3f("uMaterial.diffuse", 1.0f, 0.5f, 0.31f);
        lightingShader.SetVec3f("uMaterial.specular", 0.5f, 0.5f, 0.5f);
        lightingShader.SetFloat("uMaterial.shininess", 32.0f);
        // set light
        lightingShader.SetVec3f("uLight.ambient", ambientColor);
        lightingShader.SetVec3f("uLight.diffuse", diffuseColor);
