...
int main(int argc, char **argv)
{
    ...
    // Shader
    Shader shader("./src/29-NormalMapping/Shaders/normal_mapping.vs", "./src/29-NormalMapping/Shaders/normal_mapping.fs");

    // load textures
    // -------------
    unsigned int diffuseMap = TextureFromFile("brickwall.jpg", "./res/textures/", false, false);
    unsigned int normalMap = TextureFromFile("brickwall_normal.jpg", "./res/textures/", false, false);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.SetInt("bNormalMapping", bNormalMapping);
