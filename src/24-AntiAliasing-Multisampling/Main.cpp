...
int main(int argc, char **argv)
{
    ...
    // Shader
    Shader shader("./src/24-AntiAliasing-Multisampling/Shaders/advanced.vs", "./src/24-AntiAliasing-Multisampling/Shaders/advanced.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.Use();
        glm::mat4 projection = glm::perspective(camera.Fov, (float)SCREEN_WIDTH / (float)SCREEN_HEIGHT, 0.1f, 1000.0f);
