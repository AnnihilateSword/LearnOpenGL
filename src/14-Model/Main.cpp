...
int main(int argc, char** argv)
{
    ...
    // 1. shader
    Shader lightingShader("./src/14-Model/Shaders/VertexShader.glsl", "./src/14-Model/Shaders/FragmentShader.glsl");
    Shader lightCubeShader("./src/14-Model/Shaders/LightCubeVertexShader.glsl", "./src/14-Model/Shaders/LightCubeFragmentShader.glsl");

    Shader ModelShader("./src/14-Model/Shaders/ModelVertexShader.glsl", "./src/14-Model/Shaders/ModelFragmentShader.glsl");
    ...
    diffuseMap = TextureFromFile("container2.png", "./res/textures");
    specularMap = TextureFromFile("container2_specular.png", "./res/textures");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        ModelShader.Use();
        // set object material
        ModelShader.SetFloat("uMaterial.shininess", 32.0f);
        ...
        */
        // directional light
        ModelShader.SetVec3f("uDirLight.direction", -0.2f, -1.0f, -0.3f);
        ModelShader.SetVec3f("uDirLight.ambient", 0.05f, 0.05f, 0.05f);
        ModelShader.SetVec3f("uDirLight.diffuse", 0.4f, 0.4f, 0.4f);
        ModelShader.SetVec3f("uDirLight.specular", 0.5f, 0.5f, 0.5f);
        // point light 1
        ModelShader.SetVec3f("uPointLights[0].position", pointLightPositions[0]);
        ModelShader.SetVec3f("uPointLights[0].ambient", 0.05f, 0.05f, 0.05f);
        ModelShader.SetVec3f("uPointLights[0].diffuse", 0.8f, 0.8f, 0.8f);
        ModelShader.SetVec3f("uPointLights[0].specular", 1.0f, 1.0f, 1.0f);
        ModelShader.SetFloat("uPointLights[0].constant", 1.0f);
        ModelShader.SetFloat("uPointLights[0].linear", 0.09f);
        ModelShader.SetFloat("uPointLights[0].quadratic", 0.032f);
        // point light 2
        ModelShader.SetVec3f("uPointLights[1].position", pointLightPositions[1]);
        ModelShader.SetVec3f("uPointLights[1].ambient", 0.05f, 0.05f, 0.05f);
        ModelShader.SetVec3f("uPointLights[1].diffuse", 0.8f, 0.8f, 0.8f);
        ModelShader.SetVec3f("uPointLights[1].specular", 1.0f, 1.0f, 1.0f);
        ModelShader.SetFloat("uPointLights[1].constant", 1.0f);
        ModelShader.SetFloat("uPointLights[1].linear", 0.09f);
        lightingShader.SetFloat("uPointLights[1].quadratic", 0.032f);
        // point light 3
        ModelShader.SetVec3f("uPointLights[2].position", pointLightPositions[2]);
        ModelShader.SetVec3f("uPointLights[2].ambient", 0.05f, 0.05f, 0.05f);
        ModelShader.SetVec3f("uPointLights[2].diffuse", 0.8f, 0.8f, 0.8f);
        ModelShader.SetVec3f("uPointLights[2].specular", 1.0f, 1.0f, 1.0f);
        ModelShader.SetFloat("uPointLights[2].constant", 1.0f);
        ModelShader.SetFloat("uPointLights[2].linear", 0.09f);
        ModelShader.SetFloat("uPointLights[2].quadratic", 0.032f);
        // point light 4
        ModelShader.SetVec3f("uPointLights[3].position", pointLightPositions[3]);
        ModelShader.SetVec3f("uPointLights[3].ambient", 0.05f, 0.05f, 0.05f);
        ModelShader.SetVec3f("uPointLights[3].diffuse", 0.8f, 0.8f, 0.8f);
        ModelShader.SetVec3f("uPointLights[3].specular", 1.0f, 1.0f, 1.0f);
        ModelShader.SetFloat("uPointLights[3].constant", 1.0f);
        ModelShader.SetFloat("uPointLights[3].linear", 0.09f);
        ModelShader.SetFloat("uPointLights[3].quadratic", 0.032f);
        // spotLight
        ModelShader.SetVec3f("uSpotLight.position", camera.Position);
        ModelShader.SetVec3f("uSpotLight.direction", camera.Front);
        ModelShader.SetVec3f("uSpotLight.ambient", 0.0f, 0.0f, 0.0f);
        ModelShader.SetVec3f("uSpotLight.diffuse", 1.0f, 1.0f, 1.0f);
        ModelShader.SetVec3f("uSpotLight.specular", 1.0f, 1.0f, 1.0f);
        ModelShader.SetFloat("uSpotLight.constant", 1.0f);
        ModelShader.SetFloat("uSpotLight.linear", 0.09f);
        ModelShader.SetFloat("uSpotLight.quadratic", 0.032f);
        ModelShader.SetFloat("uSpotLight.cutOff", glm::cos(glm::radians(12.5f)));
        ModelShader.SetFloat("uSpotLight.outerCutOff", glm::cos(glm::radians(15.0f)));

        // Model MVP
        Model = glm::mat4(1.0f);
        Model = glm::translate(Model, glm::vec3(0.0f, 0.0f, 1.2f));
        Model = glm::scale(Model, glm::vec3(0.2f));
        ModelShader.SetMat4f("uModel", Model);
        ModelShader.SetMat4f("uView", View);
        ModelShader.SetMat4f("uProjection", Projection);
    ...
    ModelShader.DeleteShaderProgram();
