...
int main(int argc, char** argv)
{
    ...
    Shader shader("./src/05-Transformations-practice2/Shaders/VertexShader.glsl", "./src/05-Transformations-practice2/Shaders/FragmentShader.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.SetMat4f("uTransform", trans);
        ...
        trans = glm::mat4(1.0f);
        trans = glm::translate(trans, glm::vec3(-0.5f, 0.5f, 0.0f));
        float scaleFactor = sinf(static_cast<float>(glfwGetTime()));
