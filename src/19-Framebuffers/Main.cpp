...
int main(int argc, char** argv)
{
    ...
    // Shader
    Shader shader("./src/19-Framebuffers/Shaders/Framebuffers.vs", "./src/19-Framebuffers/Shaders/Framebuffers.fs");
    Shader screenShader("./src/19-Framebuffers/Shaders/Framebuffers_screen.vs", "./src/19-Framebuffers/Shaders/Framebuffers_screen.fs");
