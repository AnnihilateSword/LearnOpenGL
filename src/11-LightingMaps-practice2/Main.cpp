...
int main(int argc, char** argv)
{
    ...
    // 1. shader
    Shader lightingShader("./src/11-LightingMaps-practice2/Shaders/VertexShader.glsl", "./src/11-LightingMaps-practice2/Shaders/FragmentShader.glsl");
    Shader lightCubeShader("./src/11-LightingMaps-practice2/Shaders/LightCubeVertexShader.glsl", "./src/11-LightingMaps-practice2/Shaders/LightCubeFragmentShader.glsl");
