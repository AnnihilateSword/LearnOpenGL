...
int main(int argc, char** argv)
{
    ...
    // 1. shader
    Shader lightingShader("./src/11-LightingMaps-practice3/Shaders/VertexShader.glsl", "./src/11-LightingMaps-practice3/Shaders/FragmentShader.glsl");
    Shader lightCubeShader("./src/11-LightingMaps-practice3/Shaders/LightCubeVertexShader.glsl", "./src/11-LightingMaps-practice3/Shaders/LightCubeFragmentShader.glsl");
    ...
    specularMap = LoadTexture("./res/textures/lighting_maps_specular_color.png");
